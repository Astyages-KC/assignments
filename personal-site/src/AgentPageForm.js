            ...
            <Col>
              <Form>
                <Form.Group controlId="formBasicEmail">
                  ...
                  <input value={props.streetAddress} onChange={props.handleChange} type="text" placeholder="Street Address" />
                  <Form.Control value={props.city} onChange={props.handleChange} type="input" placeholder="City" />
